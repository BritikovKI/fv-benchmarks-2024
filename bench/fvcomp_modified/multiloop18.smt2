(set-logic HORN)
(set-info :source |
  Benchmark: ../../sv-benchmarks/c/loops-crafted-1/multiloops/multiloop18.c
...
(declare-fun $main_sum9 (Int Int Int) Bool)
(declare-fun $main_inv2 (Int Int Int) Bool)
(declare-fun $main_inv4 (Int Int Int) Bool)
(declare-fun $main_if6 (Int Int Int Int Int Int) Bool)
...
(declare-fun $main_inv9 (Int Int Int) Bool)
...
(assert
  (forall ((x!16 Int) (y!17 Int) (z!18 Int))
    (=> (and (> y!17 z!18)
             ($main_inv2 x!16 y!17 z!18))
        ($main_inv2 (+ x!16 1) (- y!17 100) z!18))))
...
(assert
  (forall ((x!61 Int) (y!62 Int) (z!63 Int))
    (=> (and (< y!62 500)
             (< x!61 z!63)
             ($main_inv8 x!61 y!62 z!63))
        ($main_if6 x!61 y!62 z!63 (* x!61 10) (+ y!62 10) z!63))))
...
(assert
  (forall ((x!61 Int) (y!62 Int) (z!63 Int))
    (=> (and (not (< y!62 500))
             (< x!61 z!63)
             ($main_inv8 x!61 y!62 z!63))
        ($main_if6 x!61 y!62 z!63 (+ z!63 x!61) (+ (+ y!62 50) 40) z!63))))

; forwards $main_inv8 (line 54)
(assert
  (forall ((y!62 Int) (z!63 Int) (z!66 Int) (y!65 Int) (x!64 Int) (x!61 Int))
    (=> (and ($main_if6 x!61 y!62 z!63 x!64 y!65 z!66))
        ($main_inv8 x!64 (- z!66 100) (- z!66 100)))))

; loop entry $main_inv9 (line 67)
(assert
  (forall ((x!67 Int) (y!68 Int) (z!69 Int))
    (=> (and ($main_sum8 x!67 y!68 z!69))
        ($main_inv9 x!67 y!68 z!69))))

; loop term $main_sum9 (line 67)
(assert
  (forall ((x!70 Int) (y!71 Int) (z!72 Int))
    (=> (and (not (< y!71 x!70))
             ($main_inv9 x!70 y!71 z!72))
        ($main_sum9 x!70 y!71 z!72))))

; forwards $main_inv9 (line 67)
(assert
  (forall ((x!70 Int) (y!71 Int) (z!72 Int))
    (=> (and (< y!71 x!70)
             ($main_inv9 x!70 y!71 z!72))
        ($main_inv9 x!70 (+ y!71 1) z!72))))

; pre __VERIFIER_assert
(assert
  (forall ((x!73 Int) (y!74 Int) (z!75 Int))
    (=> (and ($main_sum9 x!73 y!74 z!75))
        ($__VERIFIER_assert_pre (ite (= x!73 y!74) 1 0)))))
