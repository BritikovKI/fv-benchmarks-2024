(set-logic HORN)
(set-info :source |
  Benchmark: ../../sv-benchmarks/c/loops-crafted-1/multiloops/multiloop17.c
...
(assert
  (forall ((x!61 Int) (z!63 Int) (y!62 Int))
    (=> (and (< x!61 z!63)
             ($main_inv8 x!61 y!62 z!63))
        ($main_inv8 (* x!61 100) (- z!63 100) (- z!63 100)))))

; loop entry $main_inv9 (line 60)
(assert
  (forall ((x!64 Int) (y!65 Int) (z!66 Int))
    (=> (and ($main_sum8 x!64 y!65 z!66))
        ($main_inv9 x!64 y!65 z!66))))

; loop term $main_sum9 (line 60)
(assert
  (forall ((x!67 Int) (y!68 Int) (z!69 Int))
    (=> (and (not (< y!68 x!67))
             ($main_inv9 x!67 y!68 z!69))
        ($main_sum9 x!67 y!68 z!69))))

; forwards $main_inv9 (line 60)
(assert
  (forall ((x!67 Int) (y!68 Int) (z!69 Int))
    (=> (and (< y!68 x!67)
             ($main_inv9 x!67 y!68 z!69))
        ($main_inv9 x!67 (+ y!68 1) z!69))))

; pre __VERIFIER_assert
(assert
  (forall ((x!70 Int) (y!71 Int) (z!72 Int))
    (=> (and ($main_sum9 x!70 y!71 z!72))
        ($__VERIFIER_assert_pre (ite (= x!70 y!71) 1 0)))))
