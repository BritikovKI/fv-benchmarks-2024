(set-logic HORN)
(set-info :source |
  Benchmark: ../../sv-benchmarks/c/loops-crafted-1/multiloops/multiloop3.c
...
(assert
  (forall ((x!7 Int) (y!8 Int) (z!9 Int))
    (=> (and (< x!7 1200)
             (> z!9 2000)
             ($main_inv1 x!7 y!8 z!9))
        ($main_if2 x!7 y!8 z!9 (+ x!7 1) y!8 z!9))))
...
(assert
  (forall ((x!7 Int) (y!8 Int) (z!9 Int))
    (=> (and (not (< x!7 1200))
             (> z!9 2000)
             ($main_inv1 x!7 y!8 z!9))
        ($main_if2 x!7 y!8 z!9 (+ x!7 1) (+ y!8 1) z!9))))
...
(assert
  (forall ((x!31 Int) (y!32 Int) (z!33 Int))
    (=> (and (> x!31 40)
             (< x!31 1000)
             ($main_inv4 x!31 y!32 z!33))
        ($main_if4 x!31 y!32 z!33 (+ x!31 1) y!32 z!33))))
...
(assert
  (forall ((x!31 Int) (y!32 Int) (z!33 Int))
    (=> (and (not (> x!31 40))
             (< x!31 1000)
             ($main_inv4 x!31 y!32 z!33))
        ($main_if4 x!31 y!32 z!33 (- x!31 1) (+ y!32 1) z!33))))

; forwards $main_inv4 (line 30)
(assert
  (forall ((x!34 Int) (y!32 Int) (y!35 Int) (z!36 Int) (x!31 Int) (z!33 Int))
    (=> (and ($main_if4 x!31 y!32 z!33 x!34 y!35 z!36))
        ($main_inv4 x!34 y!35 z!36))))

; pre __VERIFIER_assert
(assert
  (forall ((x!37 Int) (z!39 Int) (y!38 Int))
    (=> (and ($main_sum4 x!37 y!38 z!39))
        ($__VERIFIER_assert_pre (ite (= x!37 z!39) 1 0)))))
