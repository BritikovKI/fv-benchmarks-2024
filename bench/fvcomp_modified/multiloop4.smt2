(set-logic HORN)
(set-info :source |
  Benchmark: ../../sv-benchmarks/c/loops-crafted-1/multiloops/multiloop4.c
...
(assert
  (forall ((x!7 Int) (y!8 Int) (z!9 Int))
    (=> (and (< x!7 1200)
             (< z!9 2000)
             ($main_inv1 x!7 y!8 z!9))
        ($main_if2 x!7 y!8 z!9 (+ x!7 1) y!8 (+ z!9 1)))))
...
(assert
  (forall ((x!7 Int) (y!8 Int) (z!9 Int))
    (=> (and (not (< x!7 1200))
             (< z!9 2000)
             ($main_inv1 x!7 y!8 z!9))
        ($main_if2 x!7 y!8 z!9 (- x!7 1) (+ y!8 3) (+ z!9 2)))))
...
; forwards $main_inv2 (line 22)
(assert
  (forall ((x!16 Int) (y!17 Int) (z!18 Int))
    (=> (and (> y!17 z!18)
             ($main_inv2 x!16 y!17 z!18))
        ($main_inv2 x!16 (+ y!17 1) (+ z!18 2)))))
...
(assert
  (forall ((x!28 Int) (y!5 Int) (z!30 Int) (z!6 Int) (x!4 Int) (y!29 Int))
    (=> (and (>= x!28 100)
             ($main_if3 x!4 y!5 z!6 x!28 y!29 z!30))
...
(assert
  (forall ((x!37 Int) (y!38 Int) (z!39 Int))
    (=> (and (< x!37 1000)
             ($main_inv5 x!37 y!38 z!39))
        ($main_inv5 (+ x!37 10) (+ y!38 1) z!39))))

; if then
(assert
  (forall ((x!34 Int) (x!4 Int) (y!5 Int) (y!35 Int) (z!36 Int) (z!6 Int))
    (=> (and ($main_sum4 x!34 y!35 z!36))
        ($main_if4 x!4 y!5 z!6 x!34 y!35 z!36))))

; if else
(assert
  (forall ((y!41 Int) (x!4 Int) (x!40 Int) (z!6 Int) (z!42 Int) (y!5 Int))
    (=> (and ($main_sum5 x!40 y!41 z!42))
        ($main_if4 x!4 y!5 z!6 x!40 y!41 z!42))))

; pre __VERIFIER_assert
(assert
  (forall ((x!4 Int) (y!5 Int) (z!45 Int) (y!44 Int) (x!43 Int) (z!6 Int))
    (=> (and ($main_if4 x!4 y!5 z!6 x!43 y!44 z!45))
        ($__VERIFIER_assert_pre (ite (= x!43 z!45) 1 0)))))
