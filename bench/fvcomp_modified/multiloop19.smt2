(set-logic HORN)
(set-info :source |
  Benchmark: ../../sv-benchmarks/c/loops-crafted-1/multiloops/multiloop19.c
...
(assert
  (forall ((x!7 Int) (y!8 Int) (z!9 Int))
    (=> (and (< x!7 500)
             (< y!8 1000)
             ($main_inv1 x!7 y!8 z!9))
        ($main_if2 x!7 y!8 z!9 (+ x!7 100) y!8 z!9))))
...
(assert
  (forall ((x!7 Int) (y!8 Int) (z!9 Int))
    (=> (and (not (< x!7 500))
             (< y!8 1000)
             ($main_inv1 x!7 y!8 z!9))
        ($main_if2 x!7 y!8 z!9 (- x!7 200) (+ y!8 40) z!9))))
...
(assert
  (forall ((x!22 Int) (y!23 Int) (z!24 Int))
    (=> (and (>= y!23 500)
             ($main_inv3 x!22 y!23 z!24))
        ($main_inv3 x!22 (- y!23 200) (+ z!24 1000)))))
...
(assert
  (forall ((x!28 Int) (y!29 Int) (z!30 Int))
    (=> (and (>= x!28 250)
             ($main_inv4 x!28 y!29 z!30))
        ($main_inv4 (- x!28 200) y!29 (+ z!30 1000)))))
...
(assert
  (forall ((x!67 Int) (y!68 Int) (z!69 Int))
    (=> (and ($main_sum8 x!67 y!68 z!69))
        ($__VERIFIER_assert_pre (ite (= x!67 y!68) 1 0)))))
