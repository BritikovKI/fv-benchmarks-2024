(set-logic HORN)
(set-info :source |
  Benchmark: ../../sv-benchmarks/c/loops-crafted-1/multiloops/multiloop20.c
...
(assert
  (forall ((x!7 Int) (y!8 Int) (z!9 Int))
    (=> (and (< x!7 50000)
             (< x!7 1000000)
             ($main_inv1 x!7 y!8 z!9))
        ($main_if2 x!7 y!8 z!9 (+ x!7 10000) y!8 z!9))))
...
(assert
  (forall ((x!7 Int) (y!8 Int) (z!9 Int))
    (=> (and (not (< x!7 50000))
             (< x!7 1000000)
             ($main_inv1 x!7 y!8 z!9))
        ($main_if2 x!7 y!8 z!9 (+ x!7 100000) (* y!8 5) z!9))))
...
(assert
  (forall ((x!16 Int) (y!17 Int) (z!18 Int))
    (=> (and (> y!17 z!18)
             ($main_inv2 x!16 y!17 z!18))
        ($main_inv2 (div x!16 5) (div y!17 10) z!18))))
...
(assert
  (forall ((x!22 Int) (y!23 Int) (z!24 Int))
    (=> (and (> y!23 z!24)
             ($main_inv3 x!22 y!23 z!24))
        ($main_inv3 (div x!22 7) (* y!23 9) z!24))))
