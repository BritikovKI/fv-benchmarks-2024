...
(assert (forall ((|_FH_0'| Int) (|_FH_1'| Int) (|count'| Int))
  (=>
    (and (= 0 |_FH_0'|) (>= |_FH_1'| 0) (= |count'| 0))
    (itp_0 |count'| |_FH_0'| |_FH_1'|))))

(assert (forall ((_FH_0 Int) (|_FH_0'| Int) (_FH_1 Int) (|_FH_1'| Int) (count Int) (|count'| Int))
  (=>
    (and (= _FH_1 |_FH_1'|) (< _FH_0 _FH_1) (= |_FH_0'| (+ _FH_0 1)) (itp_0 count _FH_0 _FH_1) (< count 100) (= |count'| (+ count 1)))
    (itp_0 |count'| |_FH_0'| |_FH_1'|))))
...
(assert (forall ((_FH_0 Int) (|_FH_0'| Int) (_FH_1 Int) (|_FH_1'| Int) (count Int) (|count'| Int))
  (=>
    (and (= _FH_1 |_FH_1'|) (< _FH_0 _FH_1) (= |_FH_0'| (+ _FH_0 1)) (itp_1 count _FH_0 _FH_1) (< count 200) (= |count'| (+ count 1)))
    (itp_1 |count'| |_FH_0'| |_FH_1'|))))
...
(assert (forall ((_FH_0 Int) (|_FH_0'| Int) (_FH_1 Int) (|_FH_1'| Int) (count Int) (|count'| Int))
  (=>
    (and (= _FH_1 |_FH_1'|) (< _FH_0 _FH_1) (= |_FH_0'| (+ _FH_0 1)) (itp_2 count _FH_0 _FH_1) (< count 300) (= |count'| (+ count 1)))
    (itp_2 |count'| |_FH_0'| |_FH_1'|))))
...
(assert (forall ((_FH_0 Int) (|_FH_0'| Int) (_FH_1 Int) (|_FH_1'| Int) (count Int) (|count'| Int))
  (=>
    (and (= _FH_1 |_FH_1'|) (< _FH_0 _FH_1) (= |_FH_0'| (+ _FH_0 1)) (itp_3 count _FH_0 _FH_1) (< count 400) (= |count'| (+ count 1)))
    (itp_3 |count'| |_FH_0'| |_FH_1'|))))
...
(assert (forall ((_FH_0 Int) (|_FH_0'| Int) (_FH_1 Int) (|_FH_1'| Int) (count Int) (|count'| Int))
  (=>
    (and (= _FH_1 |_FH_1'|) (< _FH_0 _FH_1) (= |_FH_0'| (+ _FH_0 1)) (itp_4 count _FH_0 _FH_1) (< count 500) (= |count'| (+ count 1)))
    (itp_4 |count'| |_FH_0'| |_FH_1'|))))

(assert (forall ((_FH_0 Int) (_FH_1 Int) (count Int) (|count'| Int))
  (=>
    (and  ( not(>= _FH_0 _FH_1)) (distinct _FH_0 _FH_1) (itp_4 |count'| _FH_0 _FH_1) (>= count 500))
    false)))
