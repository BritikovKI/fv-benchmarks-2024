...
(assert (forall ((_FH_0 Int) (_FH_1 Int) (_FH_2 Int) (_FH_3 Int) (_FH_4 Int) (_FH_5 Int) (_FH_6 Int) (_FH_7 Int) (count Int) (|count'| Int))
  (=>
    (and  ( not(distinct _FH_0 0)) (distinct _FH_1 0) (or (<= _FH_0 0) (<= _FH_1 0) (<= _FH_2 0)) (distinct _FH_2 0) (FUN_4 |count'| _FH_0 _FH_1 _FH_2 _FH_3 _FH_4 _FH_5 _FH_6 _FH_7) (>= count 500))
    false)))
