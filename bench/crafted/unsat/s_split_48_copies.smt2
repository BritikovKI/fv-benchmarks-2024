...
(assert (forall ((_FH_0 Int) (|_FH_0'| Int) (_FH_1 Int) (|_FH_1'| Int) (count Int) (|count'| Int))
  (=>
   ...
   (ite (< _FH_0 5000)
        (ite (>= _FH_0 4000) 4 1)
        (ite (>= _FH_0 6000) (- 1) (- 4))))) (= |_FH_0'| (+ _FH_0 1)) (inv_0 count _FH_0 _FH_1) (< count 100) (= |count'| (+ count 1)))
    (inv_0 |count'| |_FH_0'| |_FH_1'|))))
...
(assert (forall ((_FH_0 Int) (|_FH_0'| Int) (_FH_1 Int) (|_FH_1'| Int) (count Int) (|count'| Int))
  (=>
   ...
   (ite (< _FH_0 5000)
        (ite (>= _FH_0 4000) 4 1)
        (ite (>= _FH_0 6000) (- 1) (- 4))))) (= |_FH_0'| (+ _FH_0 1)) (inv_1 count _FH_0 _FH_1) (< count 200) (= |count'| (+ count 1)))
    (inv_1 |count'| |_FH_0'| |_FH_1'|))))
...
(assert (forall ((_FH_0 Int) (|_FH_0'| Int) (_FH_1 Int) (|_FH_1'| Int) (count Int) (|count'| Int))
  (=>
   ...
   (ite (< _FH_0 5000)
        (ite (>= _FH_0 4000) 4 1)
        (ite (>= _FH_0 6000) (- 1) (- 4))))) (= |_FH_0'| (+ _FH_0 1)) (inv_2 count _FH_0 _FH_1) (< count 300) (= |count'| (+ count 1)))
    (inv_2 |count'| |_FH_0'| |_FH_1'|))))
...
(assert (forall ((_FH_0 Int) (|_FH_0'| Int) (_FH_1 Int) (|_FH_1'| Int) (count Int) (|count'| Int))
  (=>
   ...
   (ite (< _FH_0 5000)
        (ite (>= _FH_0 4000) 4 1)
        (ite (>= _FH_0 6000) (- 1) (- 4))))) (= |_FH_0'| (+ _FH_0 1)) (inv_3 count _FH_0 _FH_1) (< count 400) (= |count'| (+ count 1)))
    (inv_3 |count'| |_FH_0'| |_FH_1'|))))
...
(assert (forall ((_FH_0 Int) (|_FH_0'| Int) (_FH_1 Int) (|_FH_1'| Int) (count Int) (|count'| Int))
  (=>
   ...
   (ite (< _FH_0 5000)
        (ite (>= _FH_0 4000) 4 1)
        (ite (>= _FH_0 6000) (- 1) (- 4))))) (= |_FH_0'| (+ _FH_0 1)) (inv_4 count _FH_0 _FH_1) (< count 500) (= |count'| (+ count 1)))
    (inv_4 |count'| |_FH_0'| |_FH_1'|))))

(assert (forall ((_FH_0 Int) (_FH_1 Int) (count Int) (|count'| Int))
  (=>
    (and  ( not(= 10000 _FH_0)) (distinct _FH_1 0) (inv_4 |count'| _FH_0 _FH_1) (>= count 500))
    false)))
