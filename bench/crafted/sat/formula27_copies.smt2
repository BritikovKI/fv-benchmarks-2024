...
(assert (forall ((_FH_0 Int) (_FH_1 Int) (_FH_2 Int) (_FH_3 Int) (_FH_4 Int) (count Int) (|count'| Int))
  (=>
    (and (or (< _FH_4 0) (> _FH_4 0) (< _FH_0 0) (and (> _FH_1 (- 1)) (> (+ _FH_3 (- _FH_1)) 2)) (> (+ _FH_0 (- _FH_3)) 1) (< (+ _FH_1 (- _FH_2)) 0) (> (+ _FH_1 (- _FH_2)) 0)) (itp_4 |count'| _FH_0 _FH_1 _FH_2 _FH_3 _FH_4) (>= count 500))
    false)))
