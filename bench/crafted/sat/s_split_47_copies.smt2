...
(assert (forall ((_FH_0 Int) (|_FH_0'| Int) (_FH_1 Int) (|_FH_1'| Int) (_FH_2 Int) (|_FH_2'| Int) (count Int) (|count'| Int))
  (=>
    (and (= _FH_1 |_FH_1'|) (= |_FH_0'| (+ _FH_0 1)) (= |_FH_2'| (let ((a!1 (ite (< _FH_0 (+ (* 777 _FH_1) 3885)) 1 0)))
  (+ _FH_2 (ite (>= _FH_0 (* 777 _FH_1)) a!1 0)))) (inv_0 count _FH_0 _FH_1 _FH_2) (< count 100) (= |count'| (+ count 1)))
    (inv_0 |count'| |_FH_0'| |_FH_1'| |_FH_2'|))))
...
(assert (forall ((_FH_0 Int) (|_FH_0'| Int) (_FH_1 Int) (|_FH_1'| Int) (_FH_2 Int) (|_FH_2'| Int) (count Int) (|count'| Int))
  (=>
    (and (= _FH_1 |_FH_1'|) (= |_FH_0'| (+ _FH_0 1)) (= |_FH_2'| (let ((a!1 (ite (< _FH_0 (+ (* 777 _FH_1) 3885)) 1 0)))
  (+ _FH_2 (ite (>= _FH_0 (* 777 _FH_1)) a!1 0)))) (inv_1 count _FH_0 _FH_1 _FH_2) (< count 200) (= |count'| (+ count 1)))
    (inv_1 |count'| |_FH_0'| |_FH_1'| |_FH_2'|))))
...
(assert (forall ((_FH_0 Int) (|_FH_0'| Int) (_FH_1 Int) (|_FH_1'| Int) (_FH_2 Int) (|_FH_2'| Int) (count Int) (|count'| Int))
  (=>
    (and (= _FH_1 |_FH_1'|) (= |_FH_0'| (+ _FH_0 1)) (= |_FH_2'| (let ((a!1 (ite (< _FH_0 (+ (* 777 _FH_1) 3885)) 1 0)))
  (+ _FH_2 (ite (>= _FH_0 (* 777 _FH_1)) a!1 0)))) (inv_2 count _FH_0 _FH_1 _FH_2) (< count 300) (= |count'| (+ count 1)))
    (inv_2 |count'| |_FH_0'| |_FH_1'| |_FH_2'|))))
...
(assert (forall ((_FH_0 Int) (|_FH_0'| Int) (_FH_1 Int) (|_FH_1'| Int) (_FH_2 Int) (|_FH_2'| Int) (count Int) (|count'| Int))
  (=>
    (and (= _FH_1 |_FH_1'|) (= |_FH_0'| (+ _FH_0 1)) (= |_FH_2'| (let ((a!1 (ite (< _FH_0 (+ (* 777 _FH_1) 3885)) 1 0)))
  (+ _FH_2 (ite (>= _FH_0 (* 777 _FH_1)) a!1 0)))) (inv_3 count _FH_0 _FH_1 _FH_2) (< count 400) (= |count'| (+ count 1)))
    (inv_3 |count'| |_FH_0'| |_FH_1'| |_FH_2'|))))
...
(assert (forall ((_FH_0 Int) (|_FH_0'| Int) (_FH_1 Int) (|_FH_1'| Int) (_FH_2 Int) (|_FH_2'| Int) (count Int) (|count'| Int))
  (=>
    (and (= _FH_1 |_FH_1'|) (= |_FH_0'| (+ _FH_0 1)) (= |_FH_2'| (let ((a!1 (ite (< _FH_0 (+ (* 777 _FH_1) 3885)) 1 0)))
  (+ _FH_2 (ite (>= _FH_0 (* 777 _FH_1)) a!1 0)))) (inv_4 count _FH_0 _FH_1 _FH_2) (< count 500) (= |count'| (+ count 1)))
    (inv_4 |count'| |_FH_0'| |_FH_1'| |_FH_2'|))))

(assert (forall ((_FH_0 Int) (_FH_1 Int) (_FH_2 Int) (count Int) (|count'| Int))
  (=>
    (and (distinct _FH_2 3885) (>= _FH_0 (+ (* 777 _FH_1) 7770)) (inv_4 |count'| _FH_0 _FH_1 _FH_2) (>= count 500))
    false)))
